...
public class GameplayActivity extends AppCompatActivity {
   ...
   private MediaPlayer turnLeftSound;
    private MediaPlayer turnRightSound;
   ...
   private Player player;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        hitWall = new MediaPlayer[4];
        hitWall[0] =   MediaPlayer.create(GameplayActivity.this, R.raw.wall_collision);
        hitWall[1] =   MediaPlayer.create(GameplayActivity.this, R.raw.wall_collision);
        hitWall[2] =   MediaPlayer.create(GameplayActivity.this, R.raw.wall_collision);
        hitWall[3] =   MediaPlayer.create(GameplayActivity.this, R.raw.wall_collision);
        hitWall[0].setVolume(volumeControl.soundFX,volumeControl.soundFX);
        hitWall[1].setVolume(volumeControl.soundFX, 0);
        hitWall[2].setVolume(0, volumeControl.soundFX);
        hitWall[3].setVolume((volumeControl.soundFX*100)/200, (volumeControl.soundFX*100)/200);
        ...
        turnLeftSound = MediaPlayer.create(this, R.raw.swooshleft);
        turnRightSound = MediaPlayer.create(this, R.raw.swooshright);
        ...
        emptySpaceBack.setVolume((volumeControl.soundFX * 100) / 200, (volumeControl.soundFX * 100) / 200);
