...
public class InGameMenu extends AppCompatActivity {
    ...
    int omegaMenuVoice[] = {R.raw.inventory, R.raw.explain, R.raw.soundfx, R.raw.voicefx,
            R.raw.amfx, R.raw.vibration, R.raw.returntomenu, R.raw.help};
    int menuSize[] = {2, 6};
     ...
     */
   Item one = new Item(1, "Rusty Key", "rustykey", 1);
   Item two = new Item(1, "Not a Rusty Key", "notrusty", 1);
   Item three = new Item(1, "Wooden Key", "woodkey", 1);
