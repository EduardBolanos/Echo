...
public class MainActivity extends AppCompatActivity {
    ...
    int omegaMenuVoice[] = {R.raw.start, R.raw.hel, R.raw.settings,R.raw.soundfx,R.raw.voicefx,
            R.raw.amfx,R.raw.vibration, R.raw.newgame, R.raw.continuegame,R.raw.yes, R.raw.no};
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                if ((x1 < x2) && (Math.abs(x1 - x2) > 400)) {
                    ...
                    mediaPlayer = MediaPlayer.create(MainActivity.this, omegaMenuVoice[contextSelect + loc]);
